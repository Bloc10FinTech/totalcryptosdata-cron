module.exports = {
	createExchangeTickersAlerts:function(){
		...
		var exchanges=['gdax','bittrex','bitfinex','hitbtc','gate','kuna','okex','binance','huobi','gemini','kraken','bitflyer','bithumb','bitstamp','bitz','lbank','coinone','exmo','liqui','korbit','bitmex','livecoin','cex'];
